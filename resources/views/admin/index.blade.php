                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            <!-- chat item -->
                            <div class="item">
                                <img src="{{ asset('view/img/user4-128x128.jpg') }}" alt="user image" class="online">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="{{ asset('view/img/user3-128x128.jpg') }}" alt="user image" class="offline">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="{{ asset('view/img/user2-160x160.jpg') }}" alt="user image" class="offline">
